<%@ Page Language="C#" Title="外部ログインとして登録します" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="ExampleWebRole.Account.RegisterExternalLogin" %>
